...
const tickets = [
  ...
  },
  {
    ...
    estimatedCompletion: "2024-06-29",
    amount: 6500,
  },
  {
    id: "RPR-2024-006",
    ...
    issue: "Joy-Con Drift Issue",
    status: "received",
    priority: "low",
    technician: "Not Assigned",
    createdAt: "2024-06-30",
    estimatedCompletion: "2024-07-03",
    amount: 4500,
  },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Manage and track all repair requests</p>
        </div>
          ...
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mt-1">115</h3>
              </div>
