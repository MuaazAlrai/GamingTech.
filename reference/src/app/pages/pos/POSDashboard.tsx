...
const products = [
  { id: "1", name: "HDMI Cable 2.1", category: "Accessories", price: 1500, stock: 25, sku: "ACC-HDMI-001" },
  { id: "2", name: "PS5 Controller", category: "Gaming", price: 12000, stock: 8, sku: "GAME-PS5-CTRL" },
  { id: "3", name: "Xbox Series Controller", category: "Gaming", price: 11000, stock: 6, sku: "GAME-XB-CTRL" },
  { id: "4", name: "USB-C Cable", category: "Accessories", price: 800, stock: 30, sku: "ACC-USBC-001" },
  { id: "5", name: "Gaming Mouse", category: "PC Parts", price: 4500, stock: 12, sku: "PC-MOUSE-001" },
  { id: "6", name: "Mechanical Keyboard", category: "PC Parts", price: 8500, stock: 7, sku: "PC-KB-001" },
  { id: "7", name: "Thermal Paste", category: "PC Parts", price: 600, stock: 15, sku: "PC-THERM-001" },
  { id: "8", name: "Nintendo Switch Case", category: "Accessories", price: 2500, stock: 10, sku: "ACC-NSW-CASE" },
];
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex gap-2">
          <Button variant="outline" size="sm">Today's Sales: Rs. 45,000</Button>
        </div>
      </div>
