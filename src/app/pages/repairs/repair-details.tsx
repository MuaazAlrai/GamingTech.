...
export function RepairDetails() {
  ...
  return (
    <div className="space-y-6 pb-20 lg:pb-6">
      ...
      <Card><CardContent className="grid gap-4 p-5 md:grid-cols-4"><div className="rounded-lg border bg-primary/5 p-4"><p className="text-sm text-muted-foreground">Job Number</p><p className="text-xl font-bold text-primary">{ticket.jobNumber || "-"}</p></div><div className="rounded-lg border bg-primary/5 p-4"><p className="text-sm text-muted-foreground">Ticket Number</p><p className="text-xl font-bold text-primary">{ticket.ticketNumber || ticket.id}</p></div><div className="rounded-lg border p-4"><p className="text-sm text-muted-foreground">Customer Name</p><p className="font-semibold">{ticket.customer}</p></div><div className="rounded-lg border p-4"><p className="text-sm text-muted-foreground">Customer Phone</p><p className="font-semibold">{ticket.customerPhone || customer?.phone || "-"}</p></div></CardContent></Card>
